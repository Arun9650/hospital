...
/* -------------------------------------------------------------------------
   Generates a clean, one-click PDF of a prescription (all medicines, tests and
   advice) and downloads it. jsPDF is imported lazily so it only loads when the
   patient actually clicks Download.
   ---------------------------------------------------------------------- */
export function PrescriptionDownloadButton({
  ...
  async function download() {
    ...
    try {
      ...
      doc.text(
        "Generated by Aria Health · This is a digital prescription.",
        margin,
        pageH - 44
      );
